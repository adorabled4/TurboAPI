...
) ENGINE = InnoDB AUTO_INCREMENT = 254 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of gen_table_column
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (240, '25', 'id', '主键', 'bigint(20)', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (241, '25', 'name', '接口名称', 'varchar(256)', 'String', 'name', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', 2, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (242, '25', 'description', '接口描述', 'varchar(512)', 'String', 'description', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'textarea', '', 3, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (243, '25', 'is_free', '是否免费', 'tinyint(4)', 'Integer', 'isFree', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (244, '25', 'url', '接口地址', 'varchar(512)', 'String', 'url', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'textarea', '', 5, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (245, '25', 'method', '请求方式', 'varchar(32)', 'String', 'method', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (246, '25', 'request_param', '请求参数', 'varchar(512)', 'String', 'requestParam', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'textarea', '', 7, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (247, '25', 'request_header', '请求头', 'varchar(255)', 'String', 'requestHeader', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (248, '25', 'response_header', '响应头', 'varchar(255)', 'String', 'responseHeader', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (249, '25', 'status', '接口状态(0-关闭 ,1-开启)', 'tinyint(4)', 'Integer', 'status', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', '', 10, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (250, '25', 'user_id', '创建人', 'int(11)', 'Long', 'userId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (251, '25', 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', '1', '1', NULL, NULL, NULL, 'EQ', 'datetime', '', 12, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (252, '25', 'update_time', '更新时间', 'datetime', 'Date', 'updateTime', '0', '0', '1', '1', '1', NULL, NULL, 'EQ', 'datetime', '', 13, 'admin', '2023-03-10 15:49:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (253, '25', 'is_delete', '逻辑删除(1删除)', 'tinyint(4)', 'Integer', 'isDelete', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 14, 'admin', '2023-03-10 15:49:57', '', NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2023-03-11 17:53:44', 'admin', '2023-03-09 13:37:10', '', '2023-03-11 09:53:42', '管理员');
...
-- ----------------------------
INSERT INTO `t_interface_entity` VALUES (1, '随机诗句', '随机返回一句诗句, 包含作者、朝代等信息', 0, 'localhost:8123/api/poet/random', 'GET', '{}', '{}', '{}', 1, 1, '2023-03-11 18:17:20', '2023-03-11 10:17:19', 0);
